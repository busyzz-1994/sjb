...
//@param  iconList Array[string] 1-> qq  2-> 微信 3->微博
    ...
    render(){
        ...
        return (
            <div>
                ...
                {
                    iconList.indexOf('3') > -1 ? <img src={wbFill} style={{width:'35px',height:'35px'}}/> :  <img src={wbNull} style={{width:'35px',height:'35px'}}/>
                }
                {
                    iconList.indexOf('2') > -1 ? <img src={wxFill} style={{width:'35px',height:'35px'}}/> :  <img src={wxNull} style={{width:'35px',height:'35px'}}/>
                }
            </div>
        )
    }
