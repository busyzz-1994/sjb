        ...
        return (
            <div className={style.container}>
                ...
                <div className={style.content}>
                    ...
                    <TableList
                        tdHeight='58px'
                        thead={[{checked:()=>{this.checkboxAll()},isChecked:this.state.dataList.length == this.state.issueList.length},{width:'5%',name:' '},{width:'25%',name:'类型名称'},{width:'20%',name:'创建时间'},{width:'25%',name:'操作'},{width:'20%',name:'管理'}]}
                    >
