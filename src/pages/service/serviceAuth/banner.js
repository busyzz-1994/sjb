...
class Banner extends Component{
    ...
    //跳转到添加页面
    goAddBanner(){
        this.props.history.push('/service/serviceEdit/banner/detail/?bannerType=1');
    }
    //点击查看图标
    clickCheck(id,name){
        let {selectValue} = this.state;
        selectValue = selectValue == '1' ? '4' : '0'
        this.props.history.push(`/service/serviceAudit/banner/detail/${id}/?name=${name}&checked=${selectValue}&bannerType=1`)
    }
    //点击编辑图标
    clickEdit(id,name){
        this.props.history.push(`/service/serviceEdit/banner/detail/${id}/?name=${name}&checked=1&bannerType=1`)
    }
    //点击审核
    clickAuth(id,name){
        this.props.history.push(`/service/serviceAudit/banner/detail/${id}/?name=${name}&checked=2&bannerType=1`)
    }
    //点击删除图标
