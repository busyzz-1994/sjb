        ...
        return (
            <div className={style.container}>
                ...
                <div className={style.content}>
                    ...
                    {/* 操作栏结束 */}
                    <TableList
                        thead={[{checked:()=>{this.checkboxAll()},isChecked:this.state.dataList.length == this.state.issueList.length},{width:'5%',name:' '},{width:'25%',name:'标题'},{width:'10%',name:'显示区域'},{width:'10%',name:'广告类型'},{width:'25%',name:'创建时间'},{width:'20%',name:'操作'}]}
                    >
